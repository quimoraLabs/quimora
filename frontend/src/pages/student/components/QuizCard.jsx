export default function QuizCard({title, description, timeLimit, totalQuestions, handleStart}) {
  return (
      <div className="group relative w-82.5 overflow-hidden rounded-2xl border border-white/10 bg-slate-900 p-5 transition-all duration-300 hover:-translate-y-1 hover:border-blue-500/40 hover:shadow-2xl hover:shadow-blue-500/20">
        {/* Gradient Glow */}
