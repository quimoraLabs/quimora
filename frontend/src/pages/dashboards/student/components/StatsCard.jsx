...
// ✅ Clean approach: destructure all props from a single object.
function StatsCard({ label, value, change, index, Icon }) {
  return (
    <motion.div
      ...
      transition={{ delay: index * 0.08 }} // This index will work correctly now.
    ...
    >
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="p-2 rounded-2xl bg-bg-main text-text-secondary">
          {/* ✅ Render the icon directly if it is provided. */}
