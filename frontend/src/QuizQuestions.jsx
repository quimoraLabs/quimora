          ...
          >
            ...
            <div className="ml-4 flex items-center gap-1">
              <button
                ...
                className={`w-6 h-6 rounded-full border border-soft ${timerPosition === "left" ? "bg-accent" : "bg-surface"}`}
              ></button>
              <button
                onClick={() => setTimerPosition("center")}
                className={`w-6 h-6 rounded-full border border-soft ${timerPosition === "center" ? "bg-accent" : "bg-surface"}`}
              ></button>
              <button
                onClick={() => setTimerPosition("right")}
                className={`w-6 h-6 rounded-full border border-soft ${timerPosition === "right" ? "bg-accent" : "bg-surface"}`}
              ></button>
            </div>
          </div>
        </div>
